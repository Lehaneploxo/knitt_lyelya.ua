...
const translations: Record<Language, Record<string, string>> = {
  ua: {
    ...
    'product.delivery.meest.text': 'Доставка по Україні 2-5 днів. Вартість: за тарифами перевізника',
  ...
  en: {
    ...
    'product.delivery.meest.title': 'Meest',
    'product.delivery.meest.text': 'Delivery across Ukraine 2-5 days. Cost: according to carrier tariffs',
