...
const translations: Record<Language, Record<string, string>> = {
  ua: {
    ...
    'checkout.city': 'Місто',
    'checkout.address': 'Відділення / Адреса / Адресна доставка',
    ...
    'checkout.paymentCardDescription': 'Monobank (Visa, Mastercard)',
  ...
  en: {
    ...
    'checkout.city': 'City',
    'checkout.address': 'Branch / Address / Home delivery',
