...
const translations: Record<Language, Record<string, string>> = {
  ua: {
    ...
    'checkout.npCity': 'Місто / Населений пункт',
    'checkout.npCityPlaceholder': 'Введіть назву міста...',
    'checkout.npWarehouse': 'Відділення або поштомат',
    'checkout.npWarehousePlaceholder': 'Пошук відділення...',
    'checkout.npSelectCity': 'Виберіть місто зі списку',
    'checkout.npSelectWarehouse': 'Виберіть відділення зі списку',
  ...
  en: {
    ...
    'checkout.npCity': 'City / Settlement',
    'checkout.npCityPlaceholder': 'Enter city name...',
    'checkout.npWarehouse': 'Branch or parcel locker',
    'checkout.npWarehousePlaceholder': 'Search branch...',
    'checkout.npSelectCity': 'Please select a city from the list',
    'checkout.npSelectWarehouse': 'Please select a branch from the list',
