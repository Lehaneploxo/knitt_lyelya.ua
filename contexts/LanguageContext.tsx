...
const translations: Record<Language, Record<string, string>> = {
  ua: {
    ...
    'product.care.storage.title': '3. Догляд',
    'product.care.storage.text1': '• Для збереження форми рекомендується наповнювати виріб папером або тканиною.',
  ...
  en: {
    ...
    'product.care.storage.title': '3. Care',
    'product.care.storage.text1': '• To maintain shape, it is recommended to fill the product with paper or fabric.',
