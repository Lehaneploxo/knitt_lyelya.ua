...
const translations: Record<Language, Record<string, string>> = {
  ua: {
    ...
    'about.story2': 'Ми створюємо сумки та предмети домашнього декору з екологічних матеріалів. Кожен виріб, виготовлений вручну, є унікальним та наповненим характером. У своїх дизайнах ми поєднуємо сучасну лаконічність із традиційними етнічними мотивами. Це додає виробам душевності та індивідуальності, робить їх не лише функціональними, а й естетично виразними.',
    'about.story3': 'Ми виготовляємо вироби, які гармонійно поєднують стиль, екологічність і майстерність. Наші сумки та елементи декору — це більше, ніж аксесуари та предмети інтер\'єру; це історія, яку ви можете носити з собою або створювати у своєму домі.',
  ...
  en: {
    ...
    'about.story1': 'Knitt.lyelya.ua is a fusion of natural elegance, handmade craftsmanship, and ethnic authenticity.',
    'about.story2': 'We create bags and home decor items from eco-friendly materials. Each product, handcrafted, is unique and filled with character. In our designs, we combine contemporary minimalism with traditional ethnic motifs. This adds soul and individuality to our products, making them not only functional but also aesthetically expressive.',
    'about.story3': 'We create products that harmoniously combine style, eco-friendliness, and craftsmanship. Our bags and decor elements are more than accessories and interior items; they are a story you can carry with you or create in your home.',
