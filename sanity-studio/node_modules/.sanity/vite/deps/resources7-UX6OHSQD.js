...
import "./chunk-7E7WAQZA.js";
import "./chunk-OF6A7363.js";
import "./chunk-5I4Y4JKH.js";
import "./chunk-ZRQFOE7A.js";
import "./chunk-57TORMMG.js";
import "./chunk-QMHE5CX6.js";
import "./chunk-GRLST4WI.js";
import "./chunk-3SNRL2IO.js";
import "./chunk-V4OQ3NZ2.js";

// node_modules/sanity/lib/_chunks-es/resources7.js
var structureLocaleStrings = defineLocalesResources("structure", {
  ...
  "action.delete.disabled.nothing-to-delete": "This document doesn't yet exist or is already deleted",
  /** Label for the "Delete" document action button */
  "action.delete.label": "Delete",
  /** Label for the "Delete" document action while the document is being deleted */
  "action.delete.running.label": "Deleting…",
  /** Tooltip when action is disabled because the document is linked to Canvas */
  "action.disabled-by-canvas.tooltip": "Some document actions are disabled for documents linked to Canvas",
  /** Message prompting the user to confirm discarding changes */
  "action.discard-changes.confirm-dialog.confirm-discard-changes": "Are you sure you want to discard all changes since last published?",
  /** Message prompting the user to confirm discarding changes */
  "action.discard-changes.confirm-dialog.confirm-discard-changes-draft": "Are you sure you want to discard all changes and delete this draft document?",
  ...
  "action.duplicate.disabled.nothing-to-duplicate": "This document doesn't yet exist so there's nothing to duplicate",
  ...
  "action.publish.live-edit.publish-disabled": "Cannot publish since Live Edit is enabled for this document type",
  /** Tooltip for the "Publish" document action when the document has live edit enabled.*/
  "action.publish.live-edit.tooltip": "Live Edit is enabled for this content type and publishing happens automatically as you make changes",
  ...
  "action.publish.validation-issues.tooltip": "There are validation errors that need to be fixed before this document can be published",
  ...
  "action.unpublish.live-edit.disabled": "This document has live edit enabled and cannot be unpublished",
  /** Description for the archived release banner, rendered when viewing the history of a version document from the publihed view */
  "banners.archived-release.description": "This document version belongs to the archived <VersionBadge>{{title}}</VersionBadge> release",
  ...
  "banners.choose-new-document-destination.cannot-create-draft-document": "Cannot create a draft document.",
  /** The explanation displayed when a user attempts to create a new published document, but the schema type doesn't support live-editing */
  "banners.choose-new-document-destination.cannot-create-published-document": "Cannot create a published document.",
  /** The prompt displayed when a user must select a different perspective in order to create a document */
  "banners.choose-new-document-destination.choose-destination": "Choose a destination for this document:",
  /** The explanation displayed when a user attempts to create a new document in a release, but the selected release is inactive */
  "banners.choose-new-document-destination.release-inactive": "The <VersionBadge>{{title}}</VersionBadge> release is not active.",
  ...
  "banners.live-edit-draft-banner.text": "The type <strong>{{schemaType}}</strong> has <code>liveEdit</code> enabled, but a draft version of this document exists. Publish or discard the draft in order to continue live editing it.",
  ...
  "banners.obsolete-draft.draft-model-inactive.text": "The workspace does not have drafts enabled, but a draft version of this document exists.",
  /** The text for the permission check banner if the user only has one role, and it does not allow publishing this document */
  "banners.permission-check-banner.missing-permission_create_one": "Your role <Roles/> does not have permission to publish this document.",
  /** The text for the permission check banner if the user only has multiple roles, but they do not allow publishing this document */
  "banners.permission-check-banner.missing-permission_create_other": "Your roles <Roles/> do not have permission to publish this document.",
  /** The text for the permission check banner if the user only has one role, and it does not allow editing this document */
  "banners.permission-check-banner.missing-permission_update_one": "Your role <Roles/> does not have permission to edit this document.",
  /** The text for the permission check banner if the user only has multiple roles, but they do not allow editing this document */
  "banners.permission-check-banner.missing-permission_update_other": "Your roles <Roles/> do not have permission to edit this document.",
  ...
  "banners.published-release.description": "You are viewing a read-only document that was published as part of <VersionBadge>{{title}}</VersionBadge>. It can't be edited",
  /** The text for the reload button */
  "banners.reference-changed-banner.reason-changed.reload-button.text": "Reload reference",
  /** The text for the reference change banner if the reason is that the reference has been changed */
  "banners.reference-changed-banner.reason-changed.text": "This reference has changed since you opened it.",
  /** The text for the close button */
  "banners.reference-changed-banner.reason-removed.close-button.text": "Close reference",
  /** The text for the reference change banner if the reason is that the reference has been deleted */
  "banners.reference-changed-banner.reason-removed.text": "This reference has been removed since you opened it.",
  ...
  "banners.release.error.description": "An error occurred when adding document to the release: {{message}}",
  ...
  "banners.release.navigate-to-edit-description-multiple_one": "This document is part of the <VersionBadge/> release and {{count}} more release.",
  /** The text for the banner that appears when there are multiple versions but no drafts or published, more than one extra releases */
  "banners.release.navigate-to-edit-description-multiple_other": "This document is part of the <VersionBadge/> release and {{count}} more releases",
  ...
  "banners.release.navigate-to-edit-description-single": "This document is part of the <VersionBadge/> release",
  ...
  "banners.release.waiting.description": "Please hold tight while the document is added to the release. It should not take longer than a few seconds.",
  /** Title of toast that will appear in case of latency between the user adding a document to a release and the UI reflecting it */
  "banners.release.waiting.title": "Adding document to release…",
  /** The text for the revision not found banner */
  "banners.revision-not-found.description": "We couldn't find the document revision selected, please select another entry from the history list.",
  /** The text content for the scheduled draft override banner */
  "banners.scheduled-draft-override-banner.text": "A scheduled draft for this document exists. If you publish changes now they will be overwritten when the schedule runs.",
  /** The text content for the unpublished document banner when is part of a release */
  "banners.unpublished-release-banner.text": "This document will be unpublished as part of the <VersionBadge>{{title}}</VersionBadge> release.",
  /** The text content for the unpublished document banner letting the user know that the current published version is being shown */
  "banners.unpublished-release-banner.text-with-published": "Showing the current <strong>published</strong> version:",
  ...
  "canvas.banner.popover-description": "Canvas lets you author in a free-form editor that automatically maps back to the Studio as structured content - as you type.",
  /** The heading for the canvas linked banner popover */
  "canvas.banner.popover-heading": "Idea first authoring",
  /** The description for the changes banner */
  "changes.banner.description": "Showing the history for the <strong>{{perspective}}</strong> version of this document.",
  /** The tooltip for the changes banner */
  "changes.banner.tooltip": "This view shows the changes that occurred in a specific version of this document. Select a different version to see its changes",
  ...
  "compare-version.error.invalidModeParam": '"{{input}}" is not a supported document comparison mode.',
  ...
  "compare-version.error.invalidPreviousDocumentParam": "The previous document parameter is invalid.",
  /** The text for the tooltip when the "Compare versions" action for a document is disabled */
  "compare-versions.menu-item.disabled-reason": "There are no other versions of this document to compare.",
  ...
  "confirm-delete-dialog.confirmation.text_delete": "Are you sure you want to delete all the versions of this document?",
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  "confirm-delete-dialog.confirmation.text_unpublish": "Are you sure you want to unpublish “<DocumentTitle/>”?",
  /** The text body of the error dialog. */
  "confirm-delete-dialog.error.message.text": "An error occurred while loading referencing documents.",
  ...
  "confirm-delete-dialog.other-reference-count.tooltip": "We can't display metadata for these references due to a missing access token for the related datasets.",
  ...
  "confirm-delete-dialog.referential-integrity-disclaimer.text_delete": "If you delete this document, documents that refer to it will no longer be able to access it.",
  /** Warns the user of affects to other documents if the action is confirmed (unpublish) */
  "confirm-delete-dialog.referential-integrity-disclaimer.text_unpublish": "If you unpublish this document, documents that refer to it will no longer be able to access it.",
  /** Tells the user the count of how many other referring documents there are before listing them. (singular) */
  "confirm-delete-dialog.referring-document-count.text_one": "1 document refers to “<DocumentTitle/>”",
  /** Tells the user the count of how many other referring documents there are before listing them. (plural) */
  "confirm-delete-dialog.referring-document-count.text_other": "{{count}} documents refer to “<DocumentTitle/>”",
  /** Describes the list of documents that refer to the one trying to be deleted (delete) */
  "confirm-delete-dialog.referring-documents-descriptor.text_delete": "You may not be able to delete “<DocumentTitle/>” because the following documents refer to it:",
  /** Describes the list of documents that refer to the one trying to be deleted (unpublish) */
  "confirm-delete-dialog.referring-documents-descriptor.text_unpublish": "You may not be able to unpublish “<DocumentTitle/>” because the following documents refer to it:",
  ...
  "document-view.form-view.sync-lock-toast.description": "Please hold tight while the document is synced. This usually happens right after the document has been published, and it should not take more than a few seconds",
  ...
  "events.compare-with-published.description": "We're unable to load the changes for this document, probably due to history retention policy of your plan, this shows you how the <strong>{{version}}</strong> version compares to the <strong>published</strong> version.",
  ...
  "panes.document-list-pane.error.max-retries-attempted": "Not automatically retrying after {{count}} unsuccessful attempts.",
  ...
  "panes.document-operation-results.operation-error_delete": "An error occurred while attempting to delete this document. This usually means that there are other documents that refers to it.",
  /** The text when an unpublish operation failed  */
  "panes.document-operation-results.operation-error_unpublish": "An error occurred while attempting to unpublish this document. This usually means that there are other documents that refers to it.",
  ...
  "panes.document-operation-results.operation-success_delete": "The document was successfully deleted",
  /** The text when a discard changes operation succeeded  */
  "panes.document-operation-results.operation-success_discardChanges": "All changes has now been discarded. The discarded draft can still be recovered from history",
  /** The text when a duplicate operation succeeded  */
  "panes.document-operation-results.operation-success_duplicate": "The document was successfully duplicated",
  /** The text when a publish operation succeeded  */
  "panes.document-operation-results.operation-success_publish": "<Strong>{{title}}</Strong> was published",
  /** The text when a restore operation succeeded  */
  "panes.document-operation-results.operation-success_restore": "<Strong>{{title}}</Strong> was restored",
  /** The text when an unpublish operation succeeded  */
  "panes.document-operation-results.operation-success_unpublish": "<Strong>{{title}}</Strong> was unpublished. A draft has been created from the latest published revision.",
  ...
  "panes.document-pane.document-not-found.text": "The document type is not defined, and a document with the <Code>{{id}}</Code> identifier could not be found.",
  /** The title of the document not found pane if the schema is known */
  "panes.document-pane.document-not-found.title": "The document was not found",
  /** The text of the document not found pane if the schema is not found */
  "panes.document-pane.document-unknown-type.text": "This document has the schema type <Code>{{documentType}}</Code>, which is not defined as a type in the local content studio schema.",
  /** The title of the document not found pane if the schema is not found or unknown */
  "panes.document-pane.document-unknown-type.title": "Unknown document type: <Code>{{documentType}}</Code>",
  /** The title of the document not found pane if the schema is unknown */
  "panes.document-pane.document-unknown-type.without-schema.text": "This document does not exist, and no schema type was specified for it.",
  ...
  "panes.unknown-pane-type.missing-type.text": "Structure item is missing required <Code>type</Code> property.",
  /** The title of the unknown pane */
  "panes.unknown-pane-type.title": "Unknown pane type",
  /** The text to display when type is unknown */
  "panes.unknown-pane-type.unknown-type.text": "Structure item of type <Code>{{type}}</Code> is not a known entity.",
  ...
  "request-permission-dialog.description.text": "Your request will be sent to the project administrator(s). If you'd like, you can also include a note",
  ...
  "request-permission-dialog.warning.denied.text": "Your request to access this project has been declined.",
  /** The error/warning text in the request permission dialog when the user's request has been denied due to too many outstanding requests */
  "request-permission-dialog.warning.limit-reached.text": "You've reached the limit for role requests across all projects. Please wait before submitting more requests or contact an administrator for assistance.",
  ...
  "status-bar.publish-status-button.last-published-time.aria-label": "Last published {{relativeTime}}",
...
export {
  structureLocaleStrings as default
};
//# sourceMappingURL=resources7-UX6OHSQD.js.map
