import {
  ...
  useDocumentLastRev,
  useStructureTool
} from "./chunk-NLJYNMY5.js";
import "./chunk-JI3CH7LZ.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
var isPromise = (thing) => !!thing && typeof thing?.then == "function";
...
async function resolveIntent(options) {
  const resolvedPaneCache = /* @__PURE__ */ new Map(), resolvePane = createPaneResolver((nextFn) => (unresolvedPane, context, flatIndex) => {
    ...
    params: {
      ...omit_default(options.params, ["id"]),
  ...
  return routerPanesStream.pipe(
    ...
    map(([prev, curr]) => {
      for (let i = 0; i < curr.length; i++) {
        ...
        if (!isEqual_default(prevValue, currValue))
          return {
...
function useRouterPanesStream() {
  const $ = (0, import_compiler_runtime.c)(6), [routerStateSubject] = (0, import_react.useState)(_temp$5);
  let t0;
  ...
  }, t2 = [routerState, routerStateSubject], $[2] = routerState, $[3] = routerStateSubject, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), (0, import_react.useEffect)(t1, t2), routerPanes$;
}
...
function useResolvedPanes() {
  const $ = (0, import_compiler_runtime.c)(15), [error, setError] = (0, import_react.useState)(), [maximizedPane, setMaximizedPane] = (0, import_react.useState)(null);
  if (error)
    throw error;
  const {
    structureContext,
  ...
  const [data, setData] = (0, import_react.useState)(t0), routerPanesStream = useRouterPanesStream();
  let t1, t2;
  ...
  }, t2 = [rootPaneNode, routerPanesStream, structureContext], $[1] = rootPaneNode, $[2] = routerPanesStream, $[3] = structureContext, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), (0, import_react.useEffect)(t1, t2);
  let t3;
...
var IntentResolver = (0, import_react.memo)(function() {
  const $ = (0, import_compiler_runtime.c)(7), {
    ...
    rootPaneNode,
    structureContext
  } = useStructureTool(), documentStore = useDocumentStore(), [error, setError] = (0, import_react.useState)(null);
  if (error)
    throw error;
  let t0, t1;
  ...
  }, t1 = [documentStore, maybeIntent, navigate, rootPaneNode, structureContext], $[0] = documentStore, $[1] = maybeIntent, $[2] = navigate, $[3] = rootPaneNode, $[4] = structureContext, $[5] = t0, $[6] = t1) : (t0 = $[5], t1 = $[6]), (0, import_react.useEffect)(t0, t1), null;
});
...
function StructureError(t0) {
  const $ = (0, import_compiler_runtime.c)(74), {
    error
  } = t0;
  ...
  if ($[4] !== cause || $[5] !== error.helpId || $[6] !== t) {
    ...
    let t152;
    $[25] !== t ? (t152 = t("structure-error.header.text"), $[25] = t, $[26] = t152) : t152 = $[26], $[27] !== t152 ? (t9 = (0, import_jsx_runtime.jsx)(Heading, { as: "h2", children: t152 }), $[27] = t152, $[28] = t9) : t9 = $[28], T0 = Card, t2 = 4, t3 = 4, t4 = 2, t5 = "auto", t6 = 1, t7 = "inherit", t8 = path.length > 0 && (0, import_jsx_runtime.jsxs)(Stack, { space: 2, children: [
      (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: t("structure-error.structure-path.label") }),
      (0, import_jsx_runtime.jsx)(Code, { children: path.slice(1).map(_temp2$2) })
  ...
  let t16;
  $[31] !== t15 ? (t16 = (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: t15 }), $[31] = t15, $[32] = t16) : t16 = $[32];
  let t17;
  ...
  let t18;
  $[37] !== t17 ? (t18 = (0, import_jsx_runtime.jsx)(Code, { children: t17 }), $[37] = t17, $[38] = t18) : t18 = $[38];
  let t19;
  $[39] !== t16 || $[40] !== t18 ? (t19 = (0, import_jsx_runtime.jsxs)(Stack, { marginTop: 4, space: 2, children: [
    t16,
    t18
  ] }), $[39] = t16, $[40] = t18, $[41] = t19) : t19 = $[41];
  let t20;
  $[42] !== helpId || $[43] !== t ? (t20 = helpId && (0, import_jsx_runtime.jsx)(Box, { marginTop: 4, children: (0, import_jsx_runtime.jsx)(Text, { children: (0, import_jsx_runtime.jsx)("a", { href: generateHelpUrl(helpId), rel: "noopener noreferrer", target: "_blank", children: t("structure-error.docs-link.text") }) }) }), $[42] = helpId, $[43] = t, $[44] = t20) : t20 = $[44];
  let t21;
  $[45] !== t ? (t21 = t("structure-error.reload-button.text"), $[45] = t, $[46] = t21) : t21 = $[46];
  let t22;
  $[47] !== handleReload || $[48] !== t21 ? (t22 = (0, import_jsx_runtime.jsx)(Box, { marginTop: 4, children: (0, import_jsx_runtime.jsx)(Button, { text: t21, icon: SyncIcon, tone: "primary", onClick: handleReload }) }), $[47] = handleReload, $[48] = t21, $[49] = t22) : t22 = $[49];
  let t23;
  $[50] !== T0 || $[51] !== t19 || $[52] !== t2 || $[53] !== t20 || $[54] !== t22 || $[55] !== t3 || $[56] !== t4 || $[57] !== t5 || $[58] !== t6 || $[59] !== t7 || $[60] !== t8 ? (t23 = (0, import_jsx_runtime.jsxs)(T0, { marginTop: t2, padding: t3, radius: t4, overflow: t5, shadow: t6, tone: t7, children: [
    t8,
    t19,
    t20,
    t22
  ...
  let t24;
  $[62] !== T1 || $[63] !== t23 || $[64] !== t9 ? (t24 = (0, import_jsx_runtime.jsxs)(T1, { children: [
    t9,
    t23
  ] }), $[62] = T1, $[63] = t23, $[64] = t9, $[65] = t24) : t24 = $[65];
  let t25;
  return $[66] !== T2 || $[67] !== t10 || $[68] !== t11 || $[69] !== t12 || $[70] !== t13 || $[71] !== t14 || $[72] !== t24 ? (t25 = (0, import_jsx_runtime.jsx)(T2, { height: t10, overflow: t11, padding: t12, sizing: t13, tone: t14, children: t24 }), $[66] = T2, $[67] = t10, $[68] = t11, $[69] = t12, $[70] = t13, $[71] = t14, $[72] = t24, $[73] = t25) : t25 = $[73], t25;
}
function _temp2$2(segment, i) {
  return (0, import_jsx_runtime.jsx)(PathSegment, { children: segment }, `${segment}-${i}`);
}
function _temp$3() {
...
function NoDocumentTypesScreen() {
  ...
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime.jsx)(Box, { children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(WarningOutlineIcon, {}) }) }), $[0] = t0) : t0 = $[0];
  let t1;
  $[1] !== t ? (t1 = t("no-document-types-screen.title"), $[1] = t, $[2] = t1) : t1 = $[2];
  let t2;
  $[3] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(Text, { as: "h1", size: 1, weight: "medium", children: t1 }), $[3] = t1, $[4] = t2) : t2 = $[4];
  let t3;
  $[5] !== t ? (t3 = t("no-document-types-screen.subtitle"), $[5] = t, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(Text, { as: "p", muted: true, size: 1, children: t3 }), $[7] = t3, $[8] = t4) : t4 = $[8];
  let t5;
  $[9] !== t ? (t5 = t("no-document-types-screen.link-text"), $[9] = t, $[10] = t5) : t5 = $[10];
  let t6;
  $[11] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Text, { as: "p", muted: true, size: 1, children: (0, import_jsx_runtime.jsx)("a", { href: "https://www.sanity.io/docs/create-a-schema-and-configure-sanity-studio", target: "_blank", rel: "noreferrer", children: t5 }) }), $[11] = t5, $[12] = t6) : t6 = $[12];
  let t7;
  return $[13] !== t2 || $[14] !== t4 || $[15] !== t6 ? (t7 = (0, import_jsx_runtime.jsx)(Card, { height: "fill", children: (0, import_jsx_runtime.jsx)(Flex, { align: "center", height: "fill", justify: "center", padding: 4, sizing: "border", children: (0, import_jsx_runtime.jsx)(Container, { width: 0, children: (0, import_jsx_runtime.jsx)(Card, { padding: 4, radius: 2, shadow: 1, tone: "caution", children: (0, import_jsx_runtime.jsxs)(Flex, { children: [
    t0,
...
var DocumentTitle = (props) => {
  ...
  let t1;
  return $[3] !== documentTitle || $[4] !== newTitle || $[5] !== settled ? (t1 = [documentTitle, settled, newTitle], $[3] = documentTitle, $[4] = newTitle, $[5] = settled, $[6] = t1) : t1 = $[6], (0, import_react.useEffect)(t0, t1), null;
};
var PassthroughTitle = (props) => {
  ...
  let t1;
  return $[2] !== newTitle || $[3] !== title ? (t1 = [newTitle, title], $[2] = newTitle, $[3] = title, $[4] = t1) : t1 = $[4], (0, import_react.useEffect)(t0, t1), null;
};
var StructureTitle = (props) => {
  ...
  if (isLoadingPane(lastPane)) {
    let t02;
    return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime.jsx)(PassthroughTitle, {}), $[0] = t02) : t02 = $[0], t02;
  }
  if (isDocumentPane(lastPane)) {
    if (lastPane?.title) {
      let t03;
      return $[1] !== lastPane.title ? (t03 = (0, import_jsx_runtime.jsx)(PassthroughTitle, { title: lastPane.title }), $[1] = lastPane.title, $[2] = t03) : t03 = $[2], t03;
    }
    let t02;
    return $[3] !== lastPane.options.id || $[4] !== lastPane.options.type ? (t02 = (0, import_jsx_runtime.jsx)(DocumentTitle, { documentId: lastPane.options.id, documentType: lastPane.options.type }), $[3] = lastPane.options.id, $[4] = lastPane.options.type, $[5] = t02) : t02 = $[5], t02;
  }
  const t0 = lastPane?.title;
  let t1;
  return $[6] !== t0 ? (t1 = (0, import_jsx_runtime.jsx)(PassthroughTitle, { title: t0 }), $[6] = t0, $[7] = t1) : t1 = $[7], t1;
};
function useConstructDocumentTitle(activeTitle) {
  const $ = (0, import_compiler_runtime.c)(3), structureToolBaseTitle = useStructureTool().structureContext.title;
  let t0;
...
var StyledPaneLayout = dt(PaneLayout)`
  min-height: 100%;
  min-width: 320px;
`;
var isSaveHotkey = isHotkey("mod+s");
var StructureTool = (0, import_react.memo)(function(t0) {
  const $ = (0, import_compiler_runtime.c)(58), {
    ...
    media
  } = t1, [portalElement, setPortalElement] = (0, import_react.useState)(null);
  let t2;
  $[0] !== setLayoutCollapsed ? (t2 = () => setLayoutCollapsed(true), $[0] = setLayoutCollapsed, $[1] = t2) : t2 = $[1];
  const handleRootCollapse = t2;
  let t3;
  $[2] !== setLayoutCollapsed ? (t3 = () => setLayoutCollapsed(false), $[2] = setLayoutCollapsed, $[3] = t3) : t3 = $[3];
  ...
  }, t6 = [onPaneChange, resolvedPanes], $[6] = onPaneChange, $[7] = resolvedPanes, $[8] = t5, $[9] = t6) : (t5 = $[8], t6 = $[9]), (0, import_react.useEffect)(t5, t6);
  let t7, t8;
  $[10] !== pushToast ? (t7 = () => {
  ...
  }, t8 = [pushToast], $[10] = pushToast, $[11] = t7, $[12] = t8) : (t7 = $[11], t8 = $[12]), (0, import_react.useEffect)(t7, t8);
  ...
  const onSetMaximizedPane = t9, previousSelectedIndexRef = (0, import_react.useRef)(-1);
  let t10;
  ...
  let t12;
  $[22] !== navigate || $[23] !== paneDataItems || $[24] !== setMaximizedPane || $[25] !== t11 ? (t12 = [navigate, paneDataItems, t11, setMaximizedPane], $[22] = navigate, $[23] = paneDataItems, $[24] = setMaximizedPane, $[25] = t11, $[26] = t12) : t12 = $[26], (0, import_react.useEffect)(t10, t12);
  let t13, t14;
  ...
  }, t14 = [maximizedPane, paneDataItems, setMaximizedPane], $[27] = maximizedPane, $[28] = paneDataItems, $[29] = setMaximizedPane, $[30] = t13, $[31] = t14) : (t13 = $[30], t14 = $[31]), (0, import_react.useEffect)(t13, t14), !hasDefinedDocumentTypes) {
    let t152;
    return $[32] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t152 = (0, import_jsx_runtime.jsx)(NoDocumentTypesScreen, {}), $[32] = t152) : t152 = $[32], t152;
  }
  ...
  if ($[33] !== onSetMaximizedPane || $[34] !== paneItemsToShow) {
    ...
    $[36] !== onSetMaximizedPane ? (t192 = (paneData_0) => {
      ...
      return (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: pane_5 === LOADING_PANE ? (0, import_jsx_runtime.jsx)(LoadingPane, { paneKey, path, selected }) : (0, import_jsx_runtime.jsx)(StructureToolPane, { active, groupIndex, index: paneIndex, pane: pane_5, childItemId, itemId, paneKey, params: paneParams, payload, path, selected, siblingIndex, maximized, onSetMaximizedPane: () => onSetMaximizedPane(paneData_0) }) }, `${pane_5 === LOADING_PANE ? "loading" : pane_5.type}-${paneIndex}`);
    }, $[36] = onSetMaximizedPane, $[37] = t192) : t192 = $[37], t18 = paneItemsToShow.map(t192), $[33] = onSetMaximizedPane, $[34] = paneItemsToShow, $[35] = t18;
  } else
    t18 = $[35];
  let t19;
  $[38] !== isResolvingIntent || $[39] !== paneDataItems.length ? (t19 = paneDataItems.length <= 1 && isResolvingIntent && (0, import_jsx_runtime.jsx)(LoadingPane, { paneKey: "intent-resolver" }), $[38] = isResolvingIntent, $[39] = paneDataItems.length, $[40] = t19) : t19 = $[40];
  let t20;
  $[41] !== handleRootCollapse || $[42] !== handleRootExpand || $[43] !== media[1] || $[44] !== t16 || $[45] !== t18 || $[46] !== t19 ? (t20 = (0, import_jsx_runtime.jsxs)(StyledPaneLayout, { flex: 1, height: t16, minWidth: t17, onCollapse: handleRootCollapse, onExpand: handleRootExpand, children: [
    t18,
    t19
  ] }), $[41] = handleRootCollapse, $[42] = handleRootExpand, $[43] = media[1], $[44] = t16, $[45] = t18, $[46] = t19, $[47] = t20) : t20 = $[47];
  let t21;
  $[48] !== resolvedPanes ? (t21 = (0, import_jsx_runtime.jsx)(StructureTitle, { resolvedPanes }), $[48] = resolvedPanes, $[49] = t21) : t21 = $[49];
  let t22;
  $[50] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t22 = (0, import_jsx_runtime.jsx)("div", { "data-portal": "", ref: setPortalElement }), $[50] = t22) : t22 = $[50];
  let t23;
  $[51] !== t15 || $[52] !== t20 || $[53] !== t21 ? (t23 = (0, import_jsx_runtime.jsxs)(PortalProvider, { element: t15, children: [
    t20,
    t21,
    t22
  ] }), $[51] = t15, $[52] = t20, $[53] = t21, $[54] = t23) : t23 = $[54];
  let t24;
  return $[55] !== resolvedPanesValue || $[56] !== t23 ? (t24 = (0, import_jsx_runtime.jsx)(ResolvedPanesProvider, { value: resolvedPanesValue, children: t23 }), $[55] = resolvedPanesValue, $[56] = t23, $[57] = t24) : t24 = $[57], t24;
});
...
function StructureToolBoundary(t0) {
  ...
  let t3;
  $[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = [], $[2] = t3) : t3 = $[2], (0, import_react.useEffect)(_temp2, t3);
  let t4;
  $[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t4 = {
    error: null
  }, $[3] = t4) : t4 = $[3];
  const [t5, setError] = (0, import_react.useState)(t4), {
    error
  } = t5;
  if (error) {
    let t62;
    return $[4] !== error ? (t62 = (0, import_jsx_runtime.jsx)(StructureError, { error }), $[4] = error, $[5] = t62) : t62 = $[5], t62;
  }
  const t6 = source || firstSource.name;
  let t7, t8;
  $[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t7 = (0, import_jsx_runtime.jsx)(StructureTool, { onPaneChange: setActivePanes }), t8 = (0, import_jsx_runtime.jsx)(IntentResolver, {}), $[6] = t7, $[7] = t8) : (t7 = $[6], t8 = $[7]);
  let t9;
  $[8] !== defaultDocumentNode || $[9] !== structure ? (t9 = (0, import_jsx_runtime.jsxs)(StructureToolProvider, { defaultDocumentNode, structure, children: [
    t7,
    t8
  ] }), $[8] = defaultDocumentNode, $[9] = structure, $[10] = t9) : t9 = $[10];
  let t10;
  return $[11] !== t6 || $[12] !== t9 ? (t10 = (0, import_jsx_runtime.jsx)(ErrorBoundary, { onCatch: setError, children: (0, import_jsx_runtime.jsx)(SourceProvider, { name: t6, children: t9 }) }), $[11] = t6, $[12] = t9, $[13] = t10) : t10 = $[13], t10;
}
function _temp2() {
...
//# sourceMappingURL=index3-7JC2KIC6.js.map
